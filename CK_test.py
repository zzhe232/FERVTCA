...
def parse_args():
    ...
    parser.add_argument('--model_path', default='./checkpoints/CK+.pth')
...
def run_test():
    ...
    test_dataset = datasets.ImageFolder(f'{args.CK_path}/test', transform=data_transforms_test)
    ...
    plt.savefig(os.path.join('checkpoints', "CK+" + "_acc" + str(acc) + "_bacc" + ".png"))
    plt.close()
