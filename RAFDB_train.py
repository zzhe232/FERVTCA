...
def parse_args():
    ...
    parser.add_argument('--raf_path', type=str, default='datasets/RAFDB', help='RAFDB dataset path.')
...
def run_training():
    ...
    criterion_cls = mycs(temperature=1.1,label_smoothing=0.1)
