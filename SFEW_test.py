...
def parse_args():
    ...
    parser.add_argument('--FER_path', type=str, default='datasets/RAFDB', help='RAFDB dataset path.')
...
def run_test():
    ...
    test_dataset = datasets.ImageFolder(f'{args.FER_path}/test', transform=data_transforms_test)
    ...
    plot_confusion_matrix(matrix, classes=class_names, normalize=True,
                          title='RAFDB Confusion Matrix (acc: %0.2f%%)' % (acc * 100))
